...
<body class="min-h-screen font-sans antialiased bg-base-200" x-data="{
    ...
    <div class="min-h-screen flex items-center justify-center bg-base-200 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl w-full text-center">
            ...
            <!-- Error Code -->
            <h1 class="text-9xl font-bold mb-4 text-teal-600">404</h1>
            ...
            <!-- Error Message -->
            <p class="text-lg text-teal-600 mb-8 max-w-md mx-auto">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                @else
                    ...
                    <a href="/login" class="btn btn-outline rounded-full text-teal-500">
                        Sign In
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    @if($isAuthenticated)
                        ...
                        @elseif($user->isOwner())
                            ...
                            <a href="/rent-payments" class="text-sm text-teal-600 hover:underline">Rent Payments</a>
                        @elseif($user->isTenant())
                            ...
                            <a href="/portal/notifications" class="text-sm text-teal-600 hover:underline">Notifications</a>
