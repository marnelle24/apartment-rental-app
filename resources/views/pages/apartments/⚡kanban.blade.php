...
new class extends Component
{
    ...
    public function isOverdue($dueDate): bool
    {
        if (!$dueDate) {
            return false;
        }
...
<div>
    @php
        // Ensure tasks array is always initialized with all status keys
        $tasks = $tasks ?? [
            'todo' => [],
            'in_progress' => [],
            'done' => [],
             ...
             initSortable() {
                 ...
                 columns.forEach(status => {
                     ...
                     if (el && window.Sortable) {
                         this.sortables[status] = Sortable.create(el, {
                             group: 'kanban',
                             animation: 150,
                ...
                <div>
                    ...
                    <div class="flex gap-2 mb-4">
                        ...
                        @if($selectedTask->due_date)
                            <span class="badge {{ $this->isOverdue($selectedTask->due_date) ? 'badge-error' : 'badge-info' }}">
