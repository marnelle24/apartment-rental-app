...
<div>
    ...
    <x-header title="Rent Payments" separator progress-indicator>
        ...
        <x-slot:actions>
            <x-button label="Create" link="/rent-payments/create" icon="o-plus" class="btn-primary" responsive />
    ...
    <x-drawer wire:model="drawer" title="Filters" right separator with-close-button class="lg:w-1/3">
        <div class="grid gap-5"> 
            ...
            <x-select placeholder="Tenant" wire:model.live="tenant_id" :options="$tenants" icon="o-user" placeholder-value="0" /> 
            <x-select placeholder="Apartment" wire:model.live="apartment_id" :options="$apartments" icon="o-building-office" placeholder-value="0" /> 
            <x-select placeholder="Status" wire:model.live="status" :options="$statuses" icon="o-flag" placeholder-value="" /> 
        </div>
        <x-slot:actions>
